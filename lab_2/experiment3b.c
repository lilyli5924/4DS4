...
void SW_GRPA_interrupt(alt_up_character_lcd_dev *lcd) {
	alt_up_character_lcd_set_cursor_pos(lcd, 0, 1);
	alt_up_character_lcd_string(lcd, "switch 0 changed");
...
{ 
    ...
    alt_irq_register(SWITCH_GRPA_I_IRQ, lcd_0, (void*)SW_GRPA_interrupt);
